...
if (!class_exists('Spreadsheet_Excel_Writer_Workbook')) {
    ...
    use App\Includes\excel\writer\Workbook as Spreadsheet_Excel_Writer_Workbook;
}
...
class Writer extends Spreadsheet_Excel_Writer_Workbook
{
    /**
